        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-6">
            {groups.map((g) => (
              <div
                key={g.id}
                className="flex flex-col md:flex-row justify-between items-center bg-white border rounded-2xl shadow-sm p-6 hover:shadow-md transition-transform duration-200 hover:-translate-y-1"
              >
                {/* LEFT CONTENT */}
                <div className="flex-1 min-w-0 mb-4 md:mb-0 md:pr-6">
                  ...
                  <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 truncate flex items-center gap-2">
                    <img
                  ...
                  {(g.time_range_start || g.time_range_end) && (
                    <div className="mt-3 text-gray-700 text-base md:text-lg flex items-center gap-2">
