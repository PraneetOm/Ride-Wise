...
router.post("/", async (req, res) => {
  try {
    ...
    // ✅ Validate input
    if (!group_id || !user_id || !member_name || !member_email) {
    ...
    const insertMemberQuery = `
      ...
      VALUES (?, ?, ?, ?)
    `;
    db.query(insertMemberQuery, [group_id, user_id, member_name, member_email], (err) => {
...
//   const query = "DELETE FROM group_members WHERE user_id = ?";
